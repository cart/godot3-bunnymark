...
Object.defineProperty(exports, "__esModule", { value: true });
var BunnymarkV1DrawTexture = /** @class */ (function (_super) {
    __extends(BunnymarkV1DrawTexture, _super);
    function BunnymarkV1DrawTexture() {
    ...
    BunnymarkV1DrawTexture.prototype._draw = function () {
        var e_1, _a;
        try {
    ...
    BunnymarkV1DrawTexture.prototype._process = function (delta) {
        var e_2, _a;
    ...
    BunnymarkV1DrawTexture.prototype.add_bunny = function () {
        this.bunnies.push([
            new godot.Vector2(this.screen_size.x / 2, this.screen_size.y / 2),
            new godot.Vector2(godot.randi() % 200 + 50, godot.randi() % 200 + 50)
        ]);
    };
    BunnymarkV1DrawTexture.prototype.remove_bunny = function () {
        if (this.bunnies.length == 0)
            return;
        this.bunnies.pop();
    };
    BunnymarkV1DrawTexture.prototype.finish = function () {
        this.emit_signal("benchmark_finished", this.bunnies.length);
    };
    return BunnymarkV1DrawTexture;
}(godot.Node2D));
exports.default = BunnymarkV1DrawTexture;
...
Object.defineProperty(exports, "__esModule", { value: true });
var BunnymarkV1DrawTexture_1 = __webpack_require__(/*! ./BunnymarkV1DrawTexture */ "./src/BunnymarkV1DrawTexture.ts");
// godot.register_class(BunnymarkV2, "BunnymarkV2");
// godot.register_class(BunnymarkV1Sprites, "BunnymarkV1Sprites");
godot.register_class(BunnymarkV1DrawTexture_1.default, "BunnymarkV1DrawTexture");
