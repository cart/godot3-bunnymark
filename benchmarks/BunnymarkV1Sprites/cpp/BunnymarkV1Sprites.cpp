...
class BunnymarkV1Sprites : public Node2D {
        GODOT_CLASS(BunnymarkV1Sprites, Node2D);
public:
        Vector2 screenSize;
        ...
        void remove_bunny() {
                ...
                remove_child(std::get<0>(bunnies[bunnies.size() - 1]));
                bunnies.pop_back();
        }
        ...
        static void _register_methods() {
                ...
                register_method("add_bunny", &BunnymarkV1Sprites::add_bunny);
                register_method("remove_bunny", &BunnymarkV1Sprites::remove_bunny);
                register_method("finish", &BunnymarkV1Sprites::finish);
        }
};